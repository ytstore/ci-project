...
<div class="container">
  <div class="row">
    <div class="col-md-8 mt-5">
      <h1 class="text-capitalize text-danger fw-bold">cara transaksi pulsa yang mudah dan murah di metro reload</h1>
      ...
      <div class="border p-2 text-center">
        <div class="border">
            <span>Anda dapat mengirimkan seluruh Format Transaksi ke SMS/WhatsApp Center kami di bawah ini.<br></span><span class="text-uppercase">sms center</span><br><script type="text/javascript" src="https://metroreload.co.id/nocenter.php?link=no"></script><br>
            <span>WhatsApp Center</span><br>
            <a href="https://wa.me/081213512999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 081213512999</a><br>
            <a href="https://wa.me/081213514999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 081213514999</a><br>
            <a href="https://wa.me/082137434999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 082137434999</a><br>
            <a href="https://wa.me/082137450999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 082137450999</a><br>
            <a href="https://wa.me/082244047999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 082244047999</a><br>
            <a href="https://wa.me/082257289999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 082257289999</a><br>
            <a href="https://wa.me/082334952999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 082334952999</a><br>
            <a href="https://wa.me/085708057999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 085708057999</a><br>
            <a href="https://wa.me/085730723999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 085730723999</a><br>
            <a href="https://wa.me/087756061999/" class="text-decoration-none" target="_blank"><img src="/img/wa.png" alt="" width="30"> 087756061999</a>
          </div>
        ...
        <div class="border">
          <h1 class="text-capitalize text-warning">berikut format transaksi pulsa elektrik yang dapat anda gunakan :</h1>
          <p>
            <ul class="list-group-numbered">
              <li class="fw-bold">Isi pulsa tanpa kode (hanya untuk nomor GSM)</li>
              ...
              <li class="fw-bold">Isi pulsa dengan kode (untuk paket internet, SMS, telepon, pulsa transfer)</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Isi pulsa ke nomor dan produk yang sama dalam sehari</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Isi pulsa multi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Isi token PLN</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Pembelian voucher game, top up e-money, maupun voucher tv prabayar</li>
              <ul class="list-transaksi">
                <li><i class="bi bi-check2-circle me-2"></i>Format : <span class="text-danger fw-bold">KODE PRODUK.NOHP.PIN</li>
                <li><i class="bi bi-check2-circle me-2"></i>Contoh : <span class="text-primary fw-bold">SPE20.081234567895.111000</li>
              </ul>
              <li class="fw-bold">Cek tagihan PPOB</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Bayar tagihan PPOB</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Ganti nama</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Meminta rekap transaksi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Cek transaksi per tanggal</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Cek status transaksi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Cek mutasi saldo</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Cek laporan mutasi saldo per tanggal</li>
              <ul class="list-transaksi">
                <li><i class="bi bi-check2-circle me-2"></i>Format : <span class="text-danger fw-bold">CEK.TANGGAL.PIN</li>
                <li><i class="bi bi-check2-circle me-2"></i>Contoh : <span class="text-primary fw-bold">CEK.22.111000</li>
              </ul>
              <li class="fw-bold">Tambah  No. HP untuk transaksi (hanya via SMS)</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Hapus  No. HP untuk transaksi (hanya via SMS)</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Tambah YM transaksi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Hapus YM transaksi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Paralel Gtalk transaksi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Hapus Gtalk transaksi</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Lihat daftar pengirim SMS downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Konfirmasi deposit</li>
              <ul class="list-transaksi">
                ...
                <li><i class="bi bi-check2-circle me-2"></i>Note: Deposit input otomatis, konfirmasi deposit hanya digunakan pada saat deposit belum masuk lebih dari 15 menit sejak transfer.</li>
              </ul>
              <li class="fw-bold">Komplain transaksi</li>
              <ul class="list-transaksi">
                <li><i class="bi bi-check2-circle me-2"></i>Format : <span class="text-danger fw-bold">KOM.ID isi pesan</li>
              ...
              <li class="fw-bold">Mendaftarkan agen/downline baru</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Transfer saldo ke downline (ID Agen bisa diganti nomor HP agen/downline)</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Ubah markup downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Cek saldo downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Reset PIN downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Blokir downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Aktifkan downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Lihat daftar downline</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Lihat daftar downline dari downline (sub downline)</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Setting SMS buyer</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Request prefiks autoreg</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Format pendaftaran agen AUTOREG</li>
              <ul class="list-transaksi">
                ...
                <li><i class="bi bi-check2-circle me-2"></i>Note : Harus sudah melakukan request prefiks autoreg dan format pendaftaran dikirim dari No HP calon agen.</li>
              </ul>
              <li class="fw-bold">Request tiket deposit via transfer bank</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Request tiket deposit via alfamart</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Request tiket deposit via indomaret</li>
              <ul class="list-transaksi">
              ...
              <li class="fw-bold">Request tiket deposit via virtual account (VA)</li>
              <ul class="list-transaksi">
    ...
    <div class="col-md-4 mt-5">
      <!-- KANTRO METRO RELOAD -->
      <div class="border-bottom border-danger border-3 mb-2">
        <div class="bg-danger d-inline-flex p-2">
          <h5 class="text-uppercase text-white">kantor metro reload</h5> 
        </div>
      </div>
      <div class="border border-primary border-3 text-center bg-orange p-2 mb-3">
      ...
      <!-- CARA PENDAFTARAN -->
      <div class="border">
        <h5 class="text-uppercase">cara pendaftaran</h5>
      </div>
      <div class="border border-primary border-3 bg-orange text-center p-2">
        ...
        <div class="border border-warning bg-yellow my-3">
      ...
      <div class="border mt-3">
        <h5 class="text-uppercase">center transaksi online</h5>
      </div>
      <div class="border border-primary border-3 p-2 text-center mt-1">
        ...
        <div class="border p-2 my-2">
          <span>untuk bisa transaksi via <span class="text-uppercase text-danger">whatsapp</span> silahkan simpan center WhatsApp di atas.</span>
        </div>
        <span class="text-uppercase text-danger my-2">telegram center<br><script type="text/javascript" src="https://metroreload.co.id/telegramcenter.php?link=no"></script></span>
        <div class="border p-2 my-3">
          <span class="text-capitalize">untuk paralel telegram silahkan ketik : <span class="text-uppercase text-danger">tambahtl.idtelegram.pin</span> kirim ke sms center. keterangan lebih lengkap =><a href="" class="text-decoration-none text-danger">cara transaksi via telegram</a></span>
        </div>
        <span class="text-uppercase text-danger my-2">aplikasi android</span><script type="text/javascript" src="https://metroreload.co.id/android.php?referrer=TOPMD"></script>
        <div class="border p-2 my-2">
          <span class="text-capitalize">khusus pengguna android, silahkan download aplikasi <a href="" class="text-decoration-none text-danger">METRO RELOAD.</a> keterangan lebih lengkap, baca => <a href="" class="text-decoration-none text-danger">cara download dan menggunakan aplikasi android metro reload.</a></span>
        </div>
      </div>
      <!-- CUSTOMER SERVICE -->
      <div class="border mt-3">
      ...
      <div class="border border-primary border-3 text-center p-2">
        <span class="text-uppercase text-danger">layanan support</span><br><span>ready setiap hari mulai pukul 06:00-23:00 WIB ketik : KOM.isi pesan keluhan lalu kirim ke center transaksi di atas, atau chat WA CS di bawah</span><br><span class="text-uppercase text-danger fw-bold">call center<br><script type="text/javascript" src="https://metroreload.co.id/wacs.php?link=no"></script><br></span><span class="text-uppercase text-danger fw-bold">whatsapp cs<br><script type="text/javascript" src="https://metroreload.co.id/wacs.php?link=yes"></script></span><br><span class="text-uppercase text-danger fw-bold">telegram cs<br><script type="text/javascript" src="https://metroreload.co.id/telegramcs.php?link=yes"></script></span>
        <div class="border text-center p-2">
          <span>untuk terhubung dengan layanan <span class="text-danger">WhatsApp</span> dan <span class="text-danger">Telegram CS</span> kami, silahkan simpan nomor Call Center di atas.</span>
        </div>
      ...
      <div class="border mt-3">
        <h5 class="text-uppercase">rekening support deposit</h5>
      </div>
      <div class="border text-center p-2">
        <span class="fw-bold"><img src="/img/BCA.png" alt="" class="border p-2" height="60"><br><script type="text/javascript" src="https://metroreload.co.id/rekbca.php"></script></span><br>
        <span class="fw-bold"><img src="/img/BNI.png" alt="" class="border p-2" height="60"><br><script type="text/javascript" src="https://metroreload.co.id/rekbni.php"></script></span><br>
        <span class="fw-bold"><img src="/img/BRI.png" alt="" class="border p-2" height="60"><br><script type="text/javascript" src="https://metroreload.co.id/rekbri.php"></script></span><br>
        <span class="fw-bold"><img src="/img/MANDIRI.png" alt="" class="border p-2" height="60"><br><script type="text/javascript" src="https://metroreload.co.id/rekmandiri.php"></script></span><br>
      ...
      <!-- LEGALITAS SERVER -->
      <div class="border mt-3 mb-1">
        <h5 class="text-uppercase">legalitas server</h5>
      </div>
      <div class="border border-primary border-3 text-center">
