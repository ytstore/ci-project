...
<div class="container-fluid bg-heading">
  <div class="container p-3">
    ...
    <Span class="display-3 fs-1 text-white pb-3">Daftar Paket Telpon dan SMS</Span>
    </Span>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      <div class="bg-body shadow rounded mt-2 p-2">
        <h5 class="text-capitalize">daftar harga paket nelpon dan sms murah real time</h5>
        <div class="mx-2 my-2 p-2">
        <img src="/img/agen.png" alt="" class="img-fluid col-md-8 mx-auto d-block">
        </div>
        <p>Keragaman produk kami dapat menjadikan jualan pulsa Anda lebih bervariasi. Berdasarkan tingginya permintaan member dan inovasi produk-produk baru maka kami menyediakan daftar harga paket nelpon dan SMS murah di bawah ini.</p>
          ...
          <div class="accordion-item">
            <h2 class="accordion-header" id="flush-headingOne">
              <button class="accordion-button collapsed border-bottom border-top border-dark border-2 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                Format Transaksi Paket Telpon dan SMS
              </button>
            </h2>
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">
                <ul class="list-group list-transaksi"><span class="fw-bold">Cek Harga Produk</span>
                  ...
                  <li>Contoh : CH.SD.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                <ul class="list-group list-transaksi my-3"><span class="fw-bold">Transaksi Paket Telpon dan SMS</span>
                  <li>Format : KODE.NOTUJUAN.PIN</li>
                  <li>Contoh : SMS20.081231758447.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                ...
                <span>NB : Transaksi Paket Telpon dan Paket SMS harus menggunakan kode produk</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-body shadow rounded mt-2">
        <div class="bg-heading rounded-top text-center text-white p-2">
