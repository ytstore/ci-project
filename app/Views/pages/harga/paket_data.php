...
<div class="container-fluid bg-heading">
  <div class="container p-3">
    ...
    <Span class="display-3 fs-1 text-white pb-3">Daftar Harga Paket Data</Span>
    </Span>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="bg-body shadow rounded mt-2 p-2">
        <h5 class="text-capitalize">daftar harga paket data internet murah real time</h5>
        <div class="mx-2 my-2 p-2">
        <img src="/img/agen.png" alt="" class="img-fluid col-md-8 mx-auto d-block">
        </div>
        <p>Kami juga menyediakan paket data dan voucher data internet terlengkap yang bisa Anda dapatkan dengan harga murah. Di bawah ini harga paket data kami yang update otomatis karena terhubung dengan server.</p>
          ...
          <div class="accordion-item">
            <h5 class="accordion-header" id="flush-headingOne">
              <button class="accordion-button collapsed border-bottom border-top border-dark border-2 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                Format Transaksi Paket Data Internet
              </button>
            </h5>
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">
                ...
                <ul class="list-group list-transaksi my-3"><span class="fw-bold">Transaksi Paket Data Internet</span>
                  <li>Format : KODE.NOTUJUAN.PIN</li>
                  <li>Contoh : SD10.081231758447.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                ...
                <span>NB : Transaksi Paket Data Internet harus menggunakan kode produk</span>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="bg-body shadow rounded my-2">
