...
<div class="container-fluid bg-heading">
  <div class="container p-3">
    ...
    <Span class="display-3 fs-1 text-white pb-3">Daftar Harga Voucher TV</Span>
    </Span>
  </div>
</div>
...
<div class="container">
  <div class="row">
    <div class="col-md-8">
      ...
      <h5 class="text-capitalize">daftar harga voucher TV</h5>
      <div class="mx-2 my-2 p-2">
        <img src="/img/agen.png" alt="" class="img-fluid col-md-8 mx-auto d-block">
      </div>
      <p>Harga Voucher TV Prabayar yang tercantum dibawah ini adalah harga update real time langsung dari server kami. Semua produk Agen Voucher TV prabayar Termurah kami merupakan produk voucher tv skala nasional sehingga dapat digunakan transaksi dimana saja di seluruh Indonesia tanpa dibatasi regional dan cluster.</p>
          ...
          <div class="accordion-item">
            <h5 class="accordion-header" id="flush-headingOne">
              <button class="accordion-button collapsed border-bottom border-top border-dark border-2 fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                Format transaksi Voucher TV Prabayar
              </button>
            </h5>
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">
                <ul class="list-group list-transaksi"><span class="fw-bold">Cek Harga Produk</span>
                  ...
                  <li>Contoh : CH.KTV.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                <ul class="list-group list-transaksi my-3"><span class="fw-bold">Transaksi Voucher TV</span>
                  <li>Format : NOMINAL.NOTUJUAN.PIN</li>
                  <li>Contoh : KTV10.081231758447.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                <span>NB : Transaksi Voucher TV Prabayar harus menggunakan kode produk.</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="bg-body rounded shadow my-3">
        ...
        <div class="text-center mt-3 p-2">
          ...
          <script type="text/javascript" src="https://metroreload.co.id/harga.php?type=js&level=RS&up=25&grup=TV"></script>
        </div>
      </div>
    </div>
