...
<div class="container-fluid bg-heading">
  <div class="container p-3">
    ...
    <Span class="display-3 fs-1 text-white pb-3">Daftar Harga Pulsa</Span>
    </Span>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-md-8">
      <div class="bg-body shadow rounded p-2 mt-2">
        <h5 class="text-capitalize">daftar harga pulsa elektrik murah real time</h5>
        <div class="mx-2 my-2 p-2">
        <img src="/img/agen.png" alt="" class="img-fluid col-md-8 mx-auto d-block">
        </div>
        <p>Hanya dengan melakukan pendaftaran secara gratis, Anda sudah bisa mendapatkan harga pulsa murah kami. Dengan menjadi Master Dealer, Anda bisa merekrut agen-agen baru di bawah jaringan anda dan bisa mendapatkan komisi dari transaksi agen Anda tersebut.
        Di bawah ini merupakan daftar harga pulsa elektrik murah kami yang sudah disesuaikan dengan harga pasar saat ini dan selalu update dari server langsung. Kami selalu berkomitmen untuk terus memberikan harga pulsa yang lebih murah kepada semua member kami. Selain murah, produk kami juga berkualitas dalam transaksi dan kevalidan SN.
        Perhatikan kode, nominal, dan tujuan pada saat melakukan transaksi supaya tidak terjadi kesalahan. Apabila terjadi kesalahan transaksi maka bukan tanggung jawab kami.
        </p>
        <div class="accordion accordion-flush" id="accordionFlushExample">
          <div class="accordion-item">
            <h5 class="accordion-header" id="flush-headingOne">
              <button class="accordion-button collapsed border-bottom border-top border-2 border-dark fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                Format Transaksi Pulsa All Operator
              </button>
            </h5>
            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
              <div class="accordion-body">
                <ul class="list-group list-transaksi"><span class="fw-bold">Cek Harga Produk</span>
                  <li>Format : CH.KODEPRODUK.PIN</li>
                  <li>Contoh : CH.SN.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                <ul class="list-group list-transaksi my-3"><span class="fw-bold">Transaksi isi Pulsa</span>
                  <li>Format : NOMINAL.NOTUJUAN.PIN</li>
                  <li>Contoh : 10.081231758447.123456</li>
                  <li class="fw-bold">** Kirim ke salah satu Nomor Sms Center/Chat Center</li>
                </ul>
                <ul class="list-group list-transaksi my-3"><span class="fw-bold">Transaksi isi Pulsa 2x</span>
                  <li>Format : NOMINAL.NOTUJUAN.2.PIN</li>
                  <li>Contoh : 10.081231758447.2.123456</li>
                  <li class="fw-bold">** Untuk Nominal dan Nomor Tujuan sama dalam sehari</li>
                </ul>
                <ul class="list-group list-transaksi my-3"><span class="fw-bold">Transaksi Pulsa Multi</span>
                  <li>Format : NOMINAL1.NOTUJUAN1.NOMINAL2.NOTUJUAN2.PIN</li>
                  <li>Contoh : 5.081231758447.10.082133786492.123456</li>
                  <li class="fw-bold">** Untuk transaksi Banyak Nomor sekaligus, maksimal 160 karakter (1 sms)</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="col-md-4 my-2">
      ...
      <!-- CARA PENDAFTARAN -->
      <div class="shadow rounded-top bg-heading p-2">
        <h5 class="text-uppercase text-white fs-5"><i class="bi bi-box-arrow-in-right me-2"></i>cara pendaftaran</h5>
      </div>
